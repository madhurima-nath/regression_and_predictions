...
The coefficient t-value is a measure of how many standard deviations the coefficient estimate is far away from 0. The farther away from zero indicates that the null hypothesis can be rejected - that is, declare a linear relationship between ozone numbers and temperature exists.
...
R-squared value: shows how close the data is to the simple linear regression model.
